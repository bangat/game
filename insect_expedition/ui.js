(function (global) {
  ...
  function create(options) {
    ...
    function modelFor(speciesId, category) {
      if(speciesId==='forest_zombie')return '<svg class="ix-zombie-icon" viewBox="0 0 64 64" aria-hidden="true"><rect x="10" y="7" width="44" height="49" rx="11" fill="#789b68"/><path d="M11 21V10l8-5 8 6 7-7 8 7 10-2v14l-10-7-7 5-11-5z" fill="#334435"/><path d="M17 31h10m11 0h10" stroke="#d23438" stroke-width="6"/><path d="M21 45h22" stroke="#253529" stroke-width="5"/><path d="M27 43v6m11-6v6" stroke="#e6dca8" stroke-width="4"/></svg>';
    ...
    return {
      setState(next) {
        ...
        if(next?.battle&&!snapshot.battle){panel=null;panelHistory=[];selection=null;}
