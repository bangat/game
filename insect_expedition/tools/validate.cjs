...
const files = ['index.html','game.html','landscape.js','config.js','emulator.js','main.js','zombie-ui.js','zombies.css','audio.js','characters.js','shared/appearance.js','avatar.js','appearance-ui.js','appearance.css','world.js','region-world.js','shared/regions.js','shared/ecology.js','shared/trials.js','ECOLOGY.md','ecology-ui.js','ecology.css','adventure-presentation.js','adventure-ui.css','housing-world.js','shared/housing.js','ui.js','styles.css','shared/data.js','shared/navigation.js','shared/battle.cjs','package.json','package-lock.json','README.md','CHARACTER_CUSTOMIZATION.md','ASSET_SOURCES.md','Start-Local.ps1','Start-Firebase.ps1','firebase.emulator.json'];
