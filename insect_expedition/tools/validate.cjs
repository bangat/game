...
const files = ['index.html','game.html','landscape.js','config.js','emulator.js','main.js','audio.js','characters.js','world.js','housing-world.js','shared/housing.js','ui.js','styles.css','shared/data.js','shared/navigation.js','shared/battle.cjs','package.json','package-lock.json','README.md','ASSET_SOURCES.md','Start-Local.ps1','Start-Firebase.ps1','firebase.emulator.json'];
