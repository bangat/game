...
exports.readAndParseJsonFiles = void 0;
 ...
 */
const readAndParseJsonFiles = (_a) => __awaiter(void 0, [_a], void 0, function* ({ filePaths, }) {
    // Ensure filePaths is always an array
    const paths = Array.isArray(filePaths) ? filePaths : [filePaths];
    const isSinglePath = !Array.isArray(filePaths);
    const readPromises = paths.map((filePath) => promises_1.default
    ...
    const results = yield Promise.allSettled(readPromises);
...
exports.readAndParseJsonFiles = readAndParseJsonFiles;
